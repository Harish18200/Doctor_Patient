...
if(isset($_POST['app-submit']))
{
  ...
  $docFees = isset($_POST['docFees']) ? $_POST['docFees'] : "null";
  $appdate = isset($_POST['appdate']) ? $_POST['appdate'] : "null";
  $apptime = isset($_POST['apptime']) ? $_POST['apptime'] : "null";
  
  $cur_date = date("Y-m-d");
  date_default_timezone_set('Asia/Kolkata');
  $cur_time = date("H:i:s");
  
  $appdate1 = isset($appdate) ? strtotime($appdate) : "null";
  $apptime1 = isset($apptime) ? strtotime($apptime) : "null";
